...
**Note** : The captures previously started with tcpdump of each pod will be saved in the logs directory. The maximum capture size is 1 Gb, when this limit is exceeded the .pcap file will be overwritten
